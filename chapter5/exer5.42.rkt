  ...
  (lambda (val cont)
    (cases continuation cont
           ...
           (raise1-cont (saved-cont)
                        (apply-handler val saved-cont))
           (letcc-cont (exp1 saved-env saved-cont)
                       (apply-handler val saved-cont))
           )))
    ...
    (cases continuation cont
      ...
      (raise1-cont (saved-cont)
        ;; we put the short argument first to make the trace more readable.
                   (apply-handler val saved-cont))
      (letcc-cont (exp1 saved-env saved-cont) (value-of/k exp1 saved-env val))
      )))
...
(define value-of/k
  (lambda (exp env cont)
    (cases expression exp
      ...
      (throw-exp (exp1 exp2)
                 (value-of/k exp2 env (letcc-cont exp1 env cont)))
      )))
